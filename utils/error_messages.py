...
class ErrorMessageBuilder:
    ...
    @classmethod
    def build_error(cls, error_type: str, exception: Exception, **kwargs) -> UserError:
        """
        ...
        return UserError(
            title=title, message=message, solutions=solutions, technical_details=technical_details
        )
