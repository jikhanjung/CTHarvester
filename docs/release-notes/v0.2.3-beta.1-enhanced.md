...
**Recommended actions:**
1. Read the new [FAQ](../manual/faq.rst) for common questions
2. Check [Troubleshooting Guide](../manual/troubleshooting.rst) if you encounter issues
3. Try keyboard shortcuts (F1 to see all shortcuts)
4. Explore advanced features in the [Advanced Features Guide](../manual/advanced_features.rst)
